...
{
    public class AddOrEditEmployeePresenter
    {
        //Fields
        private readonly IAddOrEditEmployeeView view;
        ...
        //Constructor
        public AddOrEditEmployeePresenter(IAddOrEditEmployeeView view, IEmployeeRepository repository)
        {
