...
{
    public partial class EditVacationView : Form
    {
        public EditVacationView()
        {
            InitializeComponent();
        }

        private void EditVacationForm_Paint(object sender, PaintEventArgs e)
        {
        ...
        private void Cmbox_State_KeyPress(object sender, KeyPressEventArgs e)
        {
